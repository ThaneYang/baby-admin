  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="price" label="售价">
        <uni-easyinput placeholder="售价（单位分）" type="number" v-model="formData.price"></uni-easyinput>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("name,goods_url,web_disk,banner,price,is_on_sale,seller_note").get().then((res) => {
